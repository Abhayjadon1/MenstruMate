package com.miniature.menstrumate.utils;
...
import com.miniature.menstrumate.activity.CustomCalendarActivity;
import com.miniature.menstrumate.activity.LegendaCalendarActivity;
import com.miniature.menstrumate.activity.NoteActivity;
import com.miniature.menstrumate.adepter.GridAdapter;
import com.miniature.menstrumate.adepter.MoodNoteAdapter;
import com.miniature.menstrumate.adepter.MucusNoteAdapter;
import com.miniature.menstrumate.adepter.SymptomNoteAdapter;
import com.miniature.menstrumate.model.MoodNote;
import com.miniature.menstrumate.model.MucusNote;
import com.miniature.menstrumate.model.Note;
import com.miniature.menstrumate.model.Period;
import com.miniature.menstrumate.model.Settings;
import com.miniature.menstrumate.model.SymptomNote;
import com.miniature.menstrumate.model.User;
...
public class CalendarCustomView extends LinearLayout {
    ...
    private void getLegendaButtonClickEvent() {
        this.imgLegenda.setOnClickListener(new OnClickListener() {
    ...
    private void getNOTAButtonClickEvent() {
        this.imgAddNote.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
        ...
        this.addNote.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent openNote = new Intent(context.getApplicationContext(), NoteActivity.class);
                openNote.putExtra("datekey", popolaDate);
                context.startActivity(openNote);
    ...
    private void getNOTAPoppoClickEvent() {
        this.txtNote.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent openNote = new Intent(context.getApplicationContext(), NoteActivity.class);
                openNote.putExtra("datekey", popolaDate);
                context.startActivity(openNote);
