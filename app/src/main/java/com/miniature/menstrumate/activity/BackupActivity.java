...
import com.miniature.menstrumate.adepter.BackupAdapter;
...
public class BackupActivity extends AppCompatActivity {
    File backupDB;
    String backupDBPath = " MenstruMatePeriodOvulTracker// MenstruMatePeriodTracker.db";
    String backupMailDBPath = " MenstruMatePeriodOvulTracker// MenstruMatePeriodTracker.pto";
    File currentDB;
    String currentDBPath = "//data//com.androworld. MenstruMateperiodtracker//databases// MenstruMatePeriodTracker.db";
    File data;
    JCGSQLiteHelper db;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File folder = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/ MenstruMatePeriodOvulTracker/");
        if (!folder.exists()) {
            folder.mkdir();
        }
