...
import com.miniature.menstrumate.activity.MainActivity;

public class  MenstruMateSchedulingService extends IntentService {
    private NotificationManager mNotificationManager;
    String sGiorniPrima;
    String sTipo;

    public  MenstruMateSchedulingService() {
    ...
    private void sendNotification(String title, String msg) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String NOTIFICATION_CHANNEL_ID = "com.androworld. MenstruMateperiodtracker";
